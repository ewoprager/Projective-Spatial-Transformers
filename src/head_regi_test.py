...
def main():
    ...
    for iter in range(ITER_STEPS):
        ...
        plot_example_regi(fig, proj_mov, proj_init_numpy0, target, det_size, norm_factor, gradncc_sim_list,
                          rtvec_diff_list, "head_regi_test.png")
